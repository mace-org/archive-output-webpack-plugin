...
var ArchiveOutputWebpackPlugin = /** @class */ (function () {
    ...
    ArchiveOutputWebpackPlugin.prototype.apply = function (compiler) {
        var _this = this;
        compiler.hooks.emit.tapAsync(ArchiveOutputWebpackPlugin.pluginName, function (compilation, callback) {
    ...
    ArchiveOutputWebpackPlugin.pluginName = 'archive-output-webpack-plugin';
